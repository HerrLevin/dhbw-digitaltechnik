...
\subsubsection*{Bandbreitenbedarf, bandbreitenbegrenzte Übertragungskanäle}
	...
	\textbf{BBB bei NRZ:} halbe Schrittrate, d.h. optimal H. Nyquist (max Frequenz bei \glqq010101...\grqq)\\
	\textbf{BBB bei RZ:} Schrittrate, d.h. doppelt so viel wie nötig. (max Frequenz bei \glqq000000...\grqq, oder \glqq 111111...\grqq )\\
	\textbf{BBB bei AMI:} halbe Schrittrate (max Frequenz bei \glqq 111111...\grqq)\\
	\textbf{BBB bei Manchester:} Schrittrate (max Frequenz bei \glqq 000000...\grqq oder \glqq 111111 \grqq)\\
...
\textbf{Einsatz:}\\
\begin{itemize}
	\item NRZ für interne Schnittstellen, bei denen der Verzicht auf Takt- oder Masseleitung nicht relevant ist
...
\begin{enumerate}
	...
	Vor $n$ Nutzdatenbit wird eine Startbitsequenz gestellt, welche sichere TRG ermöglicht. z.B. bei NRZ: \glqq 01\grqq oder \glqq 10 \grqq. $n$ ist abhängig von der Genauigkeit der Uhren. \\
	...
	Bsp: bei RZ oder AMI reicht ein einfaches \glqq 1 \grqq-Startbit. (Keine \glqq Sequenz\grqq, weniger Overhead)\\
...
Es müssen die vier Huntingtonsche Axiome gelten: $\forall a,b,c \in W$
\end{document}